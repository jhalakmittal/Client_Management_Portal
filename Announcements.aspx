<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="Announcements.aspx.cs" Inherits="Announcements" %>
                    ...
                    <table border="0" cellpadding="5" cellspacing="5" class="table bg-success ">
                        ...
                        <tr>
                            ...
                            <td>
                                 ...
                                 <asp:TextBox  runat="server" ID="txtStudentName" class="form-control" placeholder="eg: 2016/01/29" TextMode="Date" required CssClass="form-control" />
                            </td>
                            <td>
