<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="OppType.aspx.cs" Inherits="OppType" %>
        ...
        <div>
            ...
            <div class="input-group">
                <div class="form-inline">              
                    <table border="0" cellpadding="5" cellspacing="5" class="table bg-success " style="margin-top:80px!important">
                        <tr  class="alert-danger">
                            <td >
                                <span style="font-size:larger; width:700px" >Client/Opportunity Type</span>
                            </td>                            
                            <td>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:TextBox runat="server" ID="txtStudentId" class="form-control" placeholder="Web development" required  CssClass="form-control" />
                            </td>                          
